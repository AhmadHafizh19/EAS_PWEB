...
if (strlen($_SESSION['id']==0)) {
  header('location:logout.php');
    ...
    {
        $userid = $_SESSION['id'];
        $msg=mysqli_query($con,"update users set status = 'verifikasi' where id='$userid'");
        if($msg)
        {
            echo "<script>alert('Sedang dalam proses verifikasi');</script>";
            // die;
...
{?>
                    ...
                    <div class="card mb-4">
                        ...
                        <form method="post"><input type="hidden" name="status"
                                value="Sedang dalam verifikasi panitia"><button type="submit"
                                class="btn btn-success m-4" name="verifikasi" width="400px">Ajukan
                                Verifikasi</button>
                        </form>
