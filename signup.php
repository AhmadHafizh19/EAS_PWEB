...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"select id from users where email='$email' or nik='$nik'");
    ...
    {
            $msg=mysqli_query($con,"insert into users(fname,lname,email,nik,password,contactno) values('$fname','$lname','$email',$nik,'$password','$contact')");
                                    ...
                                    <form method="post" name="signup" onsubmit="return checkpass();">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="contact" name="contact" type="text"
                                                ...
                                                title=" 14 numeric characters only" required />
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="nik" name="nik" type="text"
                                                placeholder="1234567890" required pattern="[0-9]{16}"
                                                title="16 numeric characters only" maxlength="16" required />
                                            <label for="inputcontact">NIK</label>
                                        </div>
